...
import java.util.*; //random is belongs from this package.
...
public class SignupThree  extends JFrame implements ActionListener{
    ...
    SignupThree( String formno)//constructor
    {
        ...
        c5.setBounds(330,530,200,30);
        add(c5);
        
        c6= new JCheckBox("E Statement");
        c6.setBackground(Color.WHITE);
        c6.setFont(new Font("Raleway",Font.BOLD,15));
        c6.setBounds(560,530,200,30);
        add(c6);
        
        c7= new JCheckBox("I hereby Declares that the above entered details are correct to my knowledge   ");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Raleway",Font.BOLD,12));
        c7.setBounds(100,580,550,30);
        add(c7);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            //we create a random card number 
            
            Random random=new Random();
            String cardnumber=""+Math.abs((random.nextLong()%90000000L)+5040936000000000L); //ata long type but amra atake string a convert korechi tai surute "" lagiyechi
            ...
            //exception handling korte hobe karon database ekta external entity runtime erroe aste pare
    ...
    public static void main(String ar[]){
        new SignupThree("");// class ka object
    }
}
